...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/calendly-link_widget.js":[function(require,module,exports) {
var define;
var global = arguments[3];
(function () {
  this.Calendly = {};
  this.Calendly._util = {};
}).call(this); // @see http://beeker.io/jquery-document-ready-equivalent-vanilla-javascript
...
(function () {
  ...
  findInlineParentElement = function findInlineParentElement() {
    var thisScript;
    thisScript = document.scripts[document.scripts.length - 1];
    return thisScript.parentNode;
  };

  createInlineWidgets = function createInlineWidgets() {
  ...
  shouldSkipAutoLoadInlineWidget = function shouldSkipAutoLoadInlineWidget(element) {
    return element.getAttribute('data-processed') || element.getAttribute('data-auto-load') === 'false';
  };

  createBadgeWidget = function createBadgeWidget(options) {
  ...
  extractBadgeOptions = function extractBadgeOptions(options) {
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/calendly-link_widget.js"], null)
//# sourceMappingURL=/calendly-link_widget.22ffa31b.js.map